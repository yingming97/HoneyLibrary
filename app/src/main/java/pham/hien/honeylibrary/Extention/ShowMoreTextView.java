...
public class ShowMoreTextView extends AppCompatTextView {
    ...
    public ShowMoreTextView(Context context, AttributeSet attrs) {
        ...
        int resourceIdTrimCollapsedText =
                typedArray.getResourceId(R.styleable.ReadMoreTextView_trimCollapsedText, R.string.more);
        ...
        this.colorClickableText = typedArray.getColor(R.styleable.ReadMoreTextView_colorClickableText, Color.parseColor("#7265E3"));
        ...
        this.typeFace = typedArray.getInt(R.styleable.ReadMoreTextView_typeFace, 0);
        if (typeFace == 0) {
            setTypeface(TypefaceUtils.Companion.getSemiBold(context.getAssets()));
        } else if (typeFace == 1) {
            setTypeface(TypefaceUtils.Companion.getBold(context.getAssets()));
        } else if (typeFace == 2) {
